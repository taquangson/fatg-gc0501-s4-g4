...
public class Bath implements Serializable {
    ...
    private Collection<Sem> semCollection;
    ...
    @XmlTransient
    public Collection<Sem> getSemCollection() {
        return semCollection;
    }

    public void setSemCollection(Collection<Sem> semCollection) {
        this.semCollection = semCollection;
    }
